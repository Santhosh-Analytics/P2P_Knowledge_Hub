...
[8CResult: found 11 enabled services[20C
...
[6C--------------------------------[23C
[4C- NetworkManager.service (value=6.8)[21C [ [1;37mMEDIUM[0m ]
...
[4C- getty@tty2.service (value=9.6)[25C [ [1;33mUNSAFE[0m ]
...
[4C- ly@tty1.service (value=9.6)[28C [ [1;33mUNSAFE[0m ]
[4C- ly@tty2.service (value=9.6)[28C [ [1;33mUNSAFE[0m ]
[4C- polkit.service (value=1.2)[29C [ [1;32mPROTECTED[0m ]
[4C- power-profiles-daemon.service (value=1.0)[14C [ [1;32mPROTECTED[0m ]
[4C- rescue.service (value=9.5)[29C [ [1;33mUNSAFE[0m ]
[4C- shadow.service (value=1.2)[29C [ [1;32mPROTECTED[0m ]
[4C- snapper-cleanup.service (value=6.7)[20C [ [1;37mMEDIUM[0m ]
[4C- snapper-timeline.service (value=6.7)[19C [ [1;37mMEDIUM[0m ]
...
[4C- virtqemud.service (value=9.6)[26C [ [1;33mUNSAFE[0m ]
[4C- virtsecretd.service (value=9.6)[24C [ [1;33mUNSAFE[0m ]
...
[6CFound 115 active modules[31C
...
[2C- Check if reboot is needed[32C [ [1;31mYES[0m ]
...
[2C- Total without nodev:9 noexec:15 nosuid:7 ro or noexec (W^X): 15 of total 33[0C
...
[4C- Searching update status (checkupdates)[17C [ [1;32mUP-TO-DATE[0m ]
[2C- Checking package audit tool[30C [ [1;32mINSTALLED[0m ]
[4CFound: arch-audit[40C
...
[2C- Last time synchronization[32C [ [1;32m24s[0m ]
...
------------------------------------
[2C- Checking Rootkit Hunter[34C [ [1;32mFOUND[0m ]
[2C- Checking ClamAV scanner[34C [ [1;32mFOUND[0m ]
[2C- Malware software components[30C [ [1;32mFOUND[0m ]
[4C- Active agent[43C [ [1;37mNOT FOUND[0m ]
[4C- Rootkit scanner[40C [ [1;32mFOUND[0m ]
...
================================================================================
  ...
  [1;31m![0m Vulnerable packages found [PKGS-7322] 
    - Details  : [0;36march-audit has output[0m
    - Solution : 
      https://cisofy.com/lynis/controls/PKGS-7322/

  [1;31m![0m Found promiscuous interface [NETW-3015] 
    - Details  : [0;36mvnet0[0m
    - Solution : 
  ...
  [1;33m*[0m Check process listing for processes waiting for IO requests [PROC-3614] 
    - Solution : 
    - Related resources
      * Website: [0;37mhttps://cisofy.com/lynis/controls/PROC-3614/[0m
  ...
  [1;33m*[0m Double check the permissions of home directories as some might be not strict enough. [HOME-9304] 
    - Solution : 
    - Related resources
      * Website: [0;37mhttps://cisofy.com/lynis/controls/HOME-9304/[0m
...
================================================================================
  ...
  [0;36mTests performed[0m : [1;37m240[0m
  [0;36mPlugins enabled[0m : [1;37m0[0m

  [1;33mSoftware components[0m:
  - Firewall               [[1;32mV[0m]
  - Intrusion software     [[1;31mX[0m]
